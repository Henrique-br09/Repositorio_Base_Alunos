...
if opcao == 1:
    ...
    print(f'o valor total foi de: {numero1 + numero2}')
    ...
    print(f'o valor total foi de: {numero3 - numero4}')
    ...
    print(f'o valor total foi de: {n1 * n2}')
    ...
    print(f'o valor total foi de: {nu1 / nu2}')
